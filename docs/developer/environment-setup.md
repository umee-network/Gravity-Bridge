...
switch to a new terminal and run one of these two commands. A list of all predefined tests can be found [here](https://github.com/umee-network/Gravity-Bridge/blob/main/orchestrator/test_runner/src/main.rs#L169)
